...
//     type State;
//     type Result;
//     fn render(self, canvas: C, state: Self::State) -> Self::Result;
// }
//
// pub trait StatefulViewRef<C> {
//     type State;
//     type Result;
//     fn render_stateful_ref(&self, canvas: C, state: Self::State) -> Self::Result;
//     fn render_stateful_mut(&mut self, canvas: C, state: Self::State) -> Self::Result {
